      ...
      {stats && (
        <div className="mb-8 bg-white shadow p-4 rounded-lg">
          ...
          <ul className="space-y-1">
            ...
            <li>
              Beds: {stats.beds.total} (Occupied: {stats.beds.occupied}, Available:{" "}
            ...
            <div className="bg-white shadow p-4 rounded-lg">
              ...
              <div className="mt-4 flex space-x-2">
                ...
                <button
                  onClick={() => {
                    if (newBedId.trim())
                      addBed(selectedDept._id, selectedWard.name, newBedId.trim());
                    setNewBedId("");
                  }}
                  className="bg-green-600 text-white px-4 py-2 rounded"
                >
                    ...
                    <button
                      onClick={() =>
                        openConfirm(
                          ...
                          () =>
                            removeBed(selectedDept._id, selectedWard.name, bed.id)
                        )
                      }
                      className="bg-red-500 text-white px-3 py-1 rounded"
                    >
